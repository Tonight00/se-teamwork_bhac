    ...
    public void post_AddPost(){
        ...
        call.enqueue(new Callback() {
            ...
            public void onFailure(Call call, IOException e) {
                Looper.prepare();
                Toast.makeText(fatie.this, "未连接到互联网 post 失败", Toast.LENGTH_SHORT).show();
                Looper.loop();
            }
            ...
            public void onResponse(Call call, Response response) throws IOException {
                ...
                logout_dialog.setButton(DialogInterface.BUTTON_POSITIVE, "确定", new DialogInterface.OnClickListener() {
                    ...
                    public void onClick(DialogInterface dialog, int which) {
                        ...
                        LocalBroadcastManager.getInstance(fatie.this).sendBroadcast(intent);
                        sendBroadcast(intent);

                        //结束掉本activity
                        if(!message.equals("尚不允许发布评价")){
                            finish();
                        }
