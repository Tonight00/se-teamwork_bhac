...
public class FourFragment extends BaseFragment {
    ...
    private void get1(){
        ...
        call.enqueue(new Callback() {
            ...
            public void onResponse(Call call, Response response) throws IOException {
                Looper.prepare();
                Toast.makeText(getActivity(), "未连接到互联网 get 成功", Toast.LENGTH_SHORT).show();
    ...
    public void post1(){
        ...
        call.enqueue(new Callback() {
            @Override
            public void onFailure(Call call, IOException e) {
                Toast.makeText(getActivity(), "未连接到互联网 Post Failed", Toast.LENGTH_SHORT).show();
            }
    ...
    public void post2(){
        ...
        call.enqueue(new Callback() {
            ...
            public void onFailure(Call call, IOException e) {
                Looper.prepare();
                Toast.makeText(getActivity(), "未连接到互联网 post2 失败", Toast.LENGTH_SHORT).show();
                Looper.loop();
            }
    ...
    public void get_autologin_bytoken(String token){
        ...
        call.enqueue(new Callback() {
            ...
            public void onFailure(Call call, IOException e) {
                Looper.prepare();
                Toast.makeText(getActivity(), "未连接到互联网 post 失败", Toast.LENGTH_SHORT).show();
                Looper.loop();
            }
