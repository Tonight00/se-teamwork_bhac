...
public class fabuhuodong extends AppCompatActivity {
        ...
        fabu_btn_sure.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                String place = fabu_place.getText().toString();
                    ...
                    }else if( ddl.compareTo(begin)>0 || ddl.compareTo(begin)==0){
                        Toast.makeText(fabuhuodong.this, "请按照规则选择时间", Toast.LENGTH_SHORT).show();
                    }else if( begin.compareTo(end)>0  || begin.compareTo(end)==0){
                        Toast.makeText(fabuhuodong.this, "请按照规则选择时间", Toast.LENGTH_SHORT).show();
                    }else{
                        //此为检查成功后，进行的操作
                        //Toast.makeText(login.this,"检查成功",Toast.LENGTH_SHORT).show();
                        post_addActivity(selected_tagid);
                    }
    ...
    public void get_getTags(){
        ...
        call.enqueue(new Callback() {
            ...
            public void onFailure(Call call, IOException e) {
                Looper.prepare();
                Toast.makeText(fabuhuodong.this, "未连接到互联网(get 失败)", Toast.LENGTH_SHORT).show();
                Looper.loop();
            }
    ...
    public void post_addActivity(int tag){
        ...
        FormBody body = new FormBody.Builder()
                ...
                .add("category",""+taglist.get(tag).getId())
        ...
        call.enqueue(new Callback() {
            ...
            public void onFailure(Call call, IOException e) {
                Looper.prepare();
                Toast.makeText(fabuhuodong.this, "未连接到互联网(post2 失败)", Toast.LENGTH_SHORT).show();
                Looper.loop();
            }
            ...
            public void onResponse(Call call, Response response) throws IOException {
                Looper.prepare();
                //Toast.makeText(fabuhuodong.this, "未连接到互联网(post2 成功)", Toast.LENGTH_SHORT).show();
